...
a persistence unit "prueba2PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba2/pom.xml":
...
artifact ("prueba2.war") is already built. You can build
